...
const ServicesPage = () => {
  return (
    <div className='mb-10'>
      <h1 className='text-primary font-bold text-5xl lg:w-[68%] lg:text-start text-center m-auto mt-5'>Services</h1>
      <div
        className='h-[45ex] bg-cover my-[10ex]'
        style={{ backgroundImage: `url('/alphaa/15.jpg')`, backgroundPosition: 'center' }}
      >
      ...
      <div className='flex flex-col gap-5 justify-center items-center mb-[10ex] '>
        ...
        <h3 className='text-4xl font-bold lg:text-start text-center'>Find the right home for your budget</h3>
      </div>
      <Services />
    </div>
  )
