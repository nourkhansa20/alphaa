...
export const Button = ({ size, color, className, width = 'h-13 w-[15ex] md:w-[30ex] p-2', onClick, children, withoutWidth, isLoading = false, ...props }) => {
    ...
    return (
        <div className={` flex justify-center gap-2 rounded-md font-semibold border-primary cursor-pointer
        ${width}
        ${className}`}>
            <button
                {...props}
